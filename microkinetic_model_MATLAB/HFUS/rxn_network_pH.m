function rates = rxn_network_pH(t,y,n_OH_nd,n_O_nd,ks_nd,ks_fit)
% input time, concentrations, OH rate, O rate, rate constants, rate
% constants fit

    global extents coeffs ind_OH ind_O2 ind_H2O ind_H3O l_ks ind_fit ind_OHn
    ...
    rates(ind_O2) = 0 ;
    rates(ind_H2O) = 0 ;
    %assign H3O+ and OH- to specified value f
    rates(ind_H3O) = 0 ;
    rates(ind_OHn) = 0 ;
end